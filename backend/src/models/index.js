...
const db = {
  ...
  Reception: require('./Reception')(sequelize, Sequelize.DataTypes),
  ShipmentDocument: require('./ShipmentDocument')(sequelize, Sequelize.DataTypes),
  Stock: require('./Stock')(sequelize, Sequelize.DataTypes),
