...
export default function NeonButton({
  ...
  const base =
    'btn-neon inline-flex justify-center items-center px-4 py-2.5 font-medium text-sm transition-all duration-250 disabled:opacity-50 disabled:cursor-not-allowed';
  const variantClass =
    variant === 'secondary'
